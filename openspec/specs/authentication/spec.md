...
WHEN a client submits a registration request with email and password,
...
THEN the system creates a user record with normalized email and a one-way hash of the password
